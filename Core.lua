...
f:SetScript("OnEvent", function()
   ...
   if SkuBeacon then
      ...
      SkuBeacon:RegisterSoundSet("probe_deep_1click", "Interface\\AddOns\\SkuBeaconSoundsets\\assets\\probe_deep_1", 5, 30, "probe_deep_1", "click_fast.mp3", "clack_fast.mp3")
      SkuBeacon:RegisterSoundSet("probe_deep_1beep", "Interface\\AddOns\\SkuBeaconSoundsets\\assets\\probe_deep_1", 5, 30, "probe_deep_1", "clack.mp3", "click.mp3")
      ...
      SkuBeacon:RegisterSoundSet("probe_mid_1click", "Interface\\AddOns\\SkuBeaconSoundsets\\assets\\probe_mid_1", 5, 30, "probe_mid_1", "click_fast.mp3", "clack_fast.mp3")
      SkuBeacon:RegisterSoundSet("probe_mid_1beep", "Interface\\AddOns\\SkuBeaconSoundsets\\assets\\probe_mid_1", 5, 30, "probe_mid_1", "clack.mp3", "click.mp3")
